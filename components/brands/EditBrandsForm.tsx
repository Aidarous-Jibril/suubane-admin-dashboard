...
interface EditBrandsFormProps {
    initialData: Brand | null;
    subcategories: Subcategory[];
};


export default function EditBrandsForm({initialData, subcategories}: EditBrandsFormProps) {
  ...
  return (
    ...
    />
     <div className="flex items-center justify-between">
        <CustomHeadings title="Edit brand" description="Edit store brand" />
        {initialData && (
          <Button
            disabled={loading}
            variant="destructive"
