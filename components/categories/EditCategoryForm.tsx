...
export const EditCategoryForm: React.FC<EditCategoryFormProps> = ({
  ...
  const title = singleCategory ? 'Edit category' : 'Create category';
  const description = singleCategory ? 'Edit a category.' : 'Add a new category';
  const toastMessage = singleCategory ? 'Category updated.' : 'Category created.';
  const action = singleCategory ? 'Save changes' : 'Create';
  ...
  return (
    ...
    />
     <div className="flex items-center justify-between">
        <CustomHeadings title={title} description={description} />
        {singleCategory && (
          <Button
            disabled={loading}
            variant="destructive"
